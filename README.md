...
🛠️ Tech Stack
LayerTechnologyFrontendReact + Vite + Tailwind CSSBackendSpring Boot (Java) + MavenDatabaseSupabase (PostgreSQL)AuthSupabase AuthFile StorageSupabase StoragePDF ParsingApache PDFBox (via Spring AI PDF Reader)SecuritySpring Security + JWT
